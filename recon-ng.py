...
class Recon(framework.module):
    def __init__(self):
        ...
        self.register_option(self.goptions, 'db_file', './data/data.db', 'yes', 'path to main database file')
        self.register_option(self.goptions, 'key_file', './data/keys.db', 'yes', 'path to API key database file')
        self.register_option(self.goptions, 'log_file', './data/cmd.log', 'yes', 'path to command log file')
        self.register_option(self.goptions, 'domain', '', 'no', 'target domain')
        self.register_option(self.goptions, 'company', '', 'no', 'target company name')
        self.register_option(self.goptions, 'user-agent', 'Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Trident/6.0)', 'yes', 'user-agent string')
        self.register_option(self.goptions, 'proxy', False, 'yes', 'proxy all requests')
        self.register_option(self.goptions, 'proxy_server', '127.0.0.1:8080', 'yes', 'proxy server')
        self.register_option(self.goptions, 'socket_timeout', 10, 'yes', 'socket timeout in seconds')
        self.register_option(self.goptions, 'verbose', True,  'yes', 'verbose output')
