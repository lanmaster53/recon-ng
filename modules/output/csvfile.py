...
class Module(framework.module):
    ...
    def __init__(self, params):
        ...
        self.register_option(self.options, 'source', 'all', 'yes', 'data source for the report')
        self.register_option(self.options, 'filename', './data/results.csv', 'yes', 'path and filename for report output')
        self.info = {
