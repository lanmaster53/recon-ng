...
class Module(framework.module):
    ...
    def __init__(self, params):
        ...
        self.info = {
                     ...
                     'Description': 'Leverages the ipinfodb.com API to geolocate the given host(s) by IP address. This module updates the \'hosts\' table of the database with the results.',
                     'Comments': [
